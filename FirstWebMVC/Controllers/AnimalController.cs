...
namespace FirstWebMVC.Controllers
{
    public class AnimalController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Age,Loai")] Animal animal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Name,Age,Loai")] Animal animal)
        {
            if (id != animal.Name)
            {
                return NotFound();
