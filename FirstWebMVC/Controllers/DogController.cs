...
namespace FirstWebMVC.Controllers
{
    public class DogController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Gender,Name,Age,Loai")] Dog dog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Gender,Name,Age,Loai")] Dog dog)
        {
            if (id != dog.Name)
            {
                return NotFound();
