...
namespace FirstWebMVC.Controllers
{
    public class CatController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CatID,Name,Age,Loai")] Cat cat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CatID,Name,Age,Loai")] Cat cat)
        {
            if (id != cat.Name)
            {
                return NotFound();
